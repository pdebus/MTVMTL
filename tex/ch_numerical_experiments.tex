...
\begin{figure}[h!]
	...
	\subref{fig:application_color1_denoised} Denoised, IRLS with $\lambda=0.09$, $5$ IRLS steps, $1$ Newton step per IRLS step
...
\begin{figure}[h!]
	...
	\subref{fig:application_color1_denoised} Denoised, IRLS with $\lambda=0.1$, $5$ IRLS steps, $1$ Newton step per IRLS step
...
\begin{figure}[h!]
	...
	\subref{fig:application_color2_denoised} Denoised, IRLS with $\lambda=0.1$, $5$ IRLS steps, $1$ Newton step per IRLS step
...
\begin{figure}[h!]
	...
	\subref{fig:application_color3_denoised} Denoised, IRLS with $\lambda_{S^2}=\lambda_{\mathbb{R}}=0.1$, $5$ IRLS steps, $1$ Newton step per IRLS step
...
\begin{figure}[h!]
	...
	\subref{fig:application_colorinpaint1_restored} Restored, IRLS with $\lambda=0.12$, $5$ IRLS steps, $1$ Newton step per IRLS step
...
\begin{figure}[h!]
	...
	\includegraphics[width=0.25\linewidth]{./figures/experiments/colorless_Pepper.jpg}
    }
    \subfloat[][First guess]{
	\label{fig:application_colorization1_guess}
	\includegraphics[width=0.25\linewidth]{./figures/experiments/recolored_fg_Pepper.jpg}
    }
    \subfloat[][Recolored]{
	\label{fig:application_colorization1_restored}
	\includegraphics[width=0.25\linewidth]{./figures/experiments/recolored_Pepper.jpg}
    }\\
	...
	\subref{fig:application_colorization1_orig} Original image "Pepper.jpg", $359\times 361$ px, 8 bit color depth
	...
	\subref{fig:application_colorization1_restored} Recolored, IRLS with $\lambda=0.01$, $5$ IRLS steps, $1$ Newton step per IRLS step
...
\begin{figure}[h!]
	...
	\subref{fig:application_flowfield1_denoised} Reconstructed, IRLS with $\lambda=0.05$, $5$ IRLS steps, $1$ Newton step per IRLS step
...
\begin{figure}[h!]
	...
	\subref{fig:application_spd1_orig} Original image: Synthetic, non-smooth SPD(3), $100\times 100$ px 
	\subref{fig:application_spd1_noise} Componentwise Gaussian noise with $\mu=0$ and $\sigma=0.2$
	\subref{fig:application_spd1_denoised} Denoised, IRLS with $\lambda=0.7$, 5 IRLS steps, 1 Newton step per IRLS
...
\subfloat[][$100\times 100$]{
	...
	Share & Routine & Library\\
	\hline
	11.60& MatrixLogarithmFrechetDerivative& MTVMTL\\
...
\end{tabular}
 ...
 \subfloat[][]{
	\label{fig:perf_spd30}
	\includegraphics[width=0.5\linewidth]{./figures/experiments/perf_spd_irls_300.pdf}
    }
...
\begin{figure}[h!]
	...
	\subref{fig:experiment_sensitivity_fit} Cone fitted to the data, resulting in aperture half-angle of $\alpha=0.8213$
