...
\begin{figure}[h!]
	...
	\subref{fig:application_colorinpaint1_restored} Restored, IRLS with $\lambda=?$, $5$ IRLS steps, $1$ newton steps per IRLS step
...
\begin{figure}[h!]
	...
	\subref{fig:application_colorization1_restored} Recolored, IRLS with $\lambda=?$, $5$ IRLS steps, $1$ newton steps per IRLS step
...
\begin{figure}[h!]
	...
	\subref{fig:application_volume1_noise} Component-wise Gaussian noise $\mu=0$, $\sigma=?$ added
