...
\begin{figure}[h!]
	...
	$[y]=\pi^{-1}(\pi(Y))$, and the horizontal space $H_YSt(n,p)$as it orthogonal complement. We
	can also see that only tangent vectors of the horizontal space modify the span, in the sense
	that their retraction (in this case using the exponential map) lies in a different equivalence class.
